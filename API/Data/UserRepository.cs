...
public class UserRepository(DataContext context, IMapper mapper) : IUserRepository   //Uses the IUserRepository interface. It also injects DataContext and calls it context
{
