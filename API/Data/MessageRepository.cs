...
public class MessageRepository(DataContext context, IMapper mapper) : IMessageRepository
{
    ...
    {
        var query = context.Messages.OrderByDescending(x => x.MessageSent).AsQueryable();  //Builds up the query
        ...
        var messages = query.ProjectTo<MessageDto>(mapper.ConfigurationProvider);   //projects it into a messageDto

        return await PagedList<MessageDto>.CreateAsync(messages, messageParams.pageNumber, messageParams.PageSize);  //returns the paged list
    }
